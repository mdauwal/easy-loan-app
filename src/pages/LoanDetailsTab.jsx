...
const LoanDetailsTab = () => {
  ...
  const [showBankDetails, setShowBankDetails] = useState(false); // Track the bank statement visibility
  ...
  const toggleBankDetails = () => {
    setShowBankDetails(!showBankDetails); // Toggle bank statement visibility
  };
