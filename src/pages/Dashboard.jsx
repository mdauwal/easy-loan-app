...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Disbursement", href: "/underwriter/disburst" },
  ...
  },
  {
    ...
    hasDropdown: true,
    children: [
      { name: "Repayment", href: "/collection/repayment" },
      { name: "Summary", href: "/collection/summary" },
      ...
      See more
            ...
            <div className="hidden sm:flex md:flex flex-col space-y-5 mb-5 mr-10">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center transition-transform transform hover:scale-105">
                <img
                  className="rounded-full mb-4 w-16 h-16 border-2 border-[#00C796] p-1"
                  src={help}
                  alt="Help"
                />
                <h2 className="text-xl font-semibold text-[#384642]">
