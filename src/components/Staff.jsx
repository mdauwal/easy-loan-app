...
// const LoanDetailsTab = ({ details }) => {
//   return (
//     <div className='w-full'>
// <table className="w-full table-auto">
//       <tbody>
//         {Object.entries(details).map(([key, value]) => (
//           <tr key={key} className="border-t border-b">
//             <td className="py-2 px-4 capitalize">{key.replace(/([A-Z])/g, ' $1')}</td>
...
//           {/* Table Details */}
//           <div className="mt-10 z-10 bg-[#ffffff] ml-10 mr-10 p-5 rounded-md shadow-lg">
...
//           <div className="flex justify-end mt-5 mb-5 text-sm">
//             <button className="bg-[#ffffff]  text-[#FF0909] outline outline-2 outline-[#FF0909] outline-offset-2 font-semibold px-4 py-2 rounded-md mr-4">
//               Decline Loan
//             </button>
